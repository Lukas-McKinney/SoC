...
static const struct TranslationEntry kTranslations[] = {
    ...
    {"See all four seats before the match starts.", "Sieh dir alle vier Plätze an, bevor die Partie beginnt."},
    {"Click a seat to toggle Human or AI.", "Klicke auf einen Platz, um zwischen Mensch und KI zu wechseln."},
    ...
    {"At least one human player is required.", "Mindestens ein menschlicher Spieler ist erforderlich."},
    {"Private multiplayer supports up to 4 humans and AI.", "Privater Mehrspieler unterstützt bis zu 4 Menschen und KI."},
    {"Open on %s", "Offen auf %s"},
    {"Connected to %s", "Verbunden mit %s"},
    {"Waiting for host to start the match.", "Warte darauf, dass der Host die Partie startet."},
    {"Host can start once the remote player connects.", "Der Host kann starten, sobald der andere Spieler verbunden ist."},
    {"Press Enter or click Start Match when ready.", "Druecke Enter oder klicke auf Partie starten, wenn ihr bereit seid."},
    {"Endpoint copied to clipboard.", "Adresse in die Zwischenablage kopiert."},
    {"Close", "Schließen"},
    {"Build (B)", "Bauen (B)"},
    {"Road", "Straße"},
    {"Wood + Clay", "Holz + Lehm"},
    ...
    {"Windowed", "Fenster"},
    {"Fullscreen", "Vollbild"},
    {"Windowed mode can be resized.", "Im Fenstermodus kann die Größe geändert werden."},
    {"Switch to windowed mode to resize.", "Zum Ändern der Größe in den Fenstermodus wechseln."},
    ...
    {"Show Board", "Spielfeld zeigen"},
    {"Show End Screen", "Endbildschirm zeigen"},
    {"Board is locked", "Spielfeld gesperrt"},
    {"Board view active", "Spielfeldansicht aktiv"},
    ...
    {"You rolled %d.", "Du hast %d gewürfelt."},
    {"Your turn. You got %s.", "Du bist am Zug. Du hast %s erhalten."},
    {"You got %s.", "Du hast %s erhalten."},
    {"%s got %s.", "%s hat %s erhalten."},
    {"No resources distributed.", "Es wurden keine Rohstoffe verteilt."},
    ...
    {"Host address is too long.", "Die Host-Adresse ist zu lang."},
    {"Press Ctrl+V to paste.", "Drücke Strg+V zum Einfügen."},
    {"Quick checks:", "Schnellcheck:"},
    {"1) Host clicked Open Lobby.", "1) Host hat auf Lobby oeffnen geklickt."},
    {"2) Use host LAN IP on same network.", "2) Host-LAN-IP im selben Netzwerk verwenden."},
    {"3) Allow app through host firewall.", "3) App in der Host-Firewall zulassen."},
    {"Likely issue: check address, port, and firewall.", "Vermutliche Ursache: Adresse, Port oder Firewall prüfen."},
    {"Likely issue: version mismatch between host and client.", "Vermutliche Ursache: Versionskonflikt zwischen Host und Client."},
    {"Likely issue: use host LAN IP, not localhost.", "Vermutliche Ursache: Host-LAN-IP statt localhost verwenden."},
    {"Likely issue: blocked by firewall or network.", "Vermutliche Ursache: Durch Firewall oder Netzwerk blockiert."},
    {"Likely issue: host address or port is incorrect.", "Vermutliche Ursache: Host-Adresse oder Port ist falsch."},
    {"Likely issue: host is unavailable.", "Vermutliche Ursache: Host ist nicht erreichbar."},
    ...
    {"Multiplayer Options", "Mehrspieleroptionen"},
    {"Road placed.", "Straße gebaut."},
    {"Settlement placed.", "Siedlung gebaut."},
    {"City built.", "Stadt gebaut."},
    {"%s built a road.", "%s hat eine Straße gebaut."},
    {"%s built a settlement.", "%s hat eine Siedlung gebaut."},
    {"%s built a city.", "%s hat eine Stadt gebaut."},
    {"Cards discarded.", "Karten abgeworfen."},
    {"%s discarded cards.", "%s hat Karten abgeworfen."},
    {"Thief moved.", "Räuber bewegt."},
    {"%s moved the thief.", "%s hat den Räuber bewegt."},
    {"%s stole from %s.", "%s hat von %s gestohlen."},
    {"Bought %s.", "%s gekauft."},
    {"Development card bought.", "Entwicklungskarte gekauft."},
    {"%s bought a development card.", "%s hat eine Entwicklungskarte gekauft."},
    {"Played %s.", "%s gespielt."},
    {"%s played %s.", "%s hat %s gespielt."},
